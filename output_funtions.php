...
jQuery("document").ready(function() {  load_puzzle() });
...
if(!function_exists("captcha_grab_init_get_puzzle")):	
	...
	function captcha_grab_init_get_puzzle() {
		...
		.captchagarb .puz_container ul li { display:block; background-image:url(?captchagrab=puzimg&i='.uniqid().');  float:left; width:75px; height:75px; overflow:hidden;  }';
